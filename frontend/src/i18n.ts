...
const jaMessages = {
  ...
  "Adding to bookmarks": "ブックマークに追加しています",
  "Added to bookmarks": "ブックマークに追加しました",
  "Removing from bookmarks": "ブックマークから削除しています",
  "Removed from bookmarks": "ブックマークから削除しました",
  "Adding to favorites": "お気に入りに追加しています",
  "Added to favorites": "お気に入りに追加しました",
  "Removing from favorites": "お気に入りから削除しています",
  "Removed from favorites": "お気に入りから削除しました",
  "Boosting post": "ブーストしています",
  "Boosted post": "ブーストしました",
  "Removing boost": "ブーストを解除しています",
  "Boost removed": "ブーストを解除しました",
  "Voting on poll": "投票しています",
  "Voted on poll": "投票しました",
  "Adding edit to send queue": "編集を送信キューに追加しています",
  "Edit added to send queue": "編集を送信キューに追加しました",
  ...
  "Console log": "コンソールログ",
  "No console messages": "コンソールメッセージはありません。",
  UserStyle: "UserStyle",
...
const semanticEnglishMessages: Partial<Record<MessageId, string>> = {
  ...
  "settings.section.plugin": "Plugins",
