...
| 0-6 | SEC-06 / SEC-07 / REL-02 の封じ込め | updater metadataとportable user dataの境界を固定し、download digest検証とsigning jobのref制限を先行 |
...
3. SEC-06でWinSparkleの更新通知とportable user dataの境界を固定し、SEC-07 download checksum、REL-02 signing job isolationを固定。
